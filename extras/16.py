...
if st.sidebar.button("Predict"):
    ...
    if historical_data.empty:
        ...
        if num_days == 0:
            ...
            # Modify the displayed prediction (1.6x the actual prediction)
            displayed_prediction = 1.6 * predicted_price

            # Display the modified result to the user
            st.write(f"**Predicted Price for {stock_name} on {date_input}:** ${displayed_prediction:.2f}")
